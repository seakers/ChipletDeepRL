...
def get_models_warm_start(num_actions, device, params, unique_des_space, num_objectives, comp_list):
    ...
    actor = Actor_start(device=device, params=params, des_space=unique_des_space, comp_list=comp_list, num_objectives=num_objectives)
...
def sample_designs(num_actions, params, unique_des_space, des_space, num_objectives, comp_list):
    ...
    for i in range(num_actions):
        log_probs, sel_actions = actor_start.sample_action(observation, i)
...
def run_warm_start_intelligent_ga(max_obj, params, eval_function):
    """
    ...
    actor_mutate = get_models_mutation(
        device=device,
        params=params,
    ...
    def intelligent_mutation(offspring, ga_instance):
        ...
        for ind, design in enumerate(offspring):
            ...
            while not stop_token:
                ...
                _, var_idx, _, value_idx, _, stop_decision = actor_mutate.sample_action(
...
def get_models_mutation(device, params, num_objectives, num_actions, unique_des_space, comp_list):
    """
