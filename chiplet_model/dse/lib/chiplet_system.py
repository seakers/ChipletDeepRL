...
from chiplet_model.dse.lib.shard_kernel import ShardKernel
# from shard_kernel import ShardKernel
...
class ChipletSystem:
    ...
    def register_chiplets(self):
        ...
        from chiplet_model.dse.chiplet_library.register_chiplet import RegisterChiplets
